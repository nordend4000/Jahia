...
{ 
   if (preg_match("#^[a-z0-9._-]+@[a-z0-9._-]{2,}\.[a-z]{2,4}$#", $_POST['email_modif']))
     ...
     {
        $pb4 = "le format de l'email n'est pas correct, les modifications n'ont pas été prisent en compte.";
        header('jahia_profil.php?pb=' . $pb4);
     }
...
$ok = 'Les informations ont bien ete modifiees !';
header('Location: jahia_profil.php?pb=' . $ok);
