...
<!DOCTYPE html>
    ...
    <title>Le site de Jahia - Pictionary</title>
    <style>
body {
...
<div id="bloc_page">
                <?php include("jahia_nav.php"); ?>

                     <h2><img src="images/push.png" alt="push decoration" width="5%">     Pictionnaire en images</h2>
                     <div style="text-align: center">
                     <img src="images/line.png" alt="line decoration" width="90%">
                     </div>
                     <p><?php echo $_SESSION['pseudo']?> Sais tu parler le language bébé Jahia ?? baba, gaga, mama, papa, aya .... facile non ??!!<br>
                        Pour les mots plus compliqués c'est plus facile en images<br> Aller selectionnes un mot dans la liste pour connaitre ma definition...</p>
                     <div id="pointer" class="centrer">
                         
                            <button id="myBtn" type="submit" value="Manger"/>Manger</button>
                            <button id="myBtn1" type="submit" value="Dormir" />Dormir</button>
                            <button id="myBtn2" type="submit" value="Jouer" />Jouer</button>
                            <button id="myBtn3" type="submit" value="Piscine" />Piscine</button>
                            <button id="myBtn4" type="submit" value="Manger"/>Fatigue</button>
                            <button id="myBtn5" type="submit" value="Dormir" />Grognon</button>
                            <button id="myBtn6" type="submit" value="Jouer" />Conduire</button>
                            <button id="myBtn7" type="submit" value="Piscine" />Potty</button>
                            <button id="myBtn8" type="submit" value="Manger"/>Champagne</button>
                            <button id="myBtn9" type="submit" value="Dormir" />Bain</button>
                            <button id="myBtn10" type="submit" value="Jouer" />Zoggs</button>
                            <button id="myBtn11" type="submit" value="Piscine" />Passeport</button>
                            <button id="myBtn12" type="submit" value="Manger"/>Duo</button>
                            <button id="myBtn13" type="submit" value="Dormir" />Trio</button>
                            <button id="myBtn14" type="submit" value="Jouer" />Quartette</button>
                            <button id="myBtn15" type="submit" value="Piscine" />Sextette</button>
