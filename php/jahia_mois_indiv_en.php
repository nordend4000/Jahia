...
<html>
    <head>
         <meta charset="utf-8" />
         <title>Jahia's website - Months after months</title>
    </head>
    <body>
    	 <div id="bloc_page">
    	 	<?php
			...
			$reponse = $bdd->prepare('SELECT id, titre, commentaire, legende, photo_mois, legende_ext, photo_ext FROM mois WHERE id = ?');
            ...
            <div class="centrer">
            	...
            	if (($_GET['mois']) >= 2)
            	{ ?>
                <h5><a href="jahia_mois_indiv_en.php?mois=<?php echo $precedent ?>">Previous Month</a></h5><?php
            	} ?>
                <h5><a href="jahia_mois_en.php">Back to 12 months</a></h5><?php
                if (($_GET['mois']) <= 11)
                { ?>
                  <h5><a href="jahia_mois_indiv_en.php?mois=<?php echo $suivant ?>">Next Month</a></h5><?php
                } ?> 
