...
if (empty($_POST['pseudo']) OR empty($_POST['pass']))
{
  // Afficher le formulaire de saisie du mot de passe
   ...
   $pbc1 = 'Ooopsss...  Wrong Id or Password !';
   header('Location: jahia_connexion_en.php?pbc=' . $pbc1);
} // grand if
...
if (!$resultat)
{
    $pbc2 = 'Ooopsss... Wrong Id or Password !';
    header('Location: jahia_connexion_en.php?pbc=' . $pbc2);
}
else
{
    if ($isPasswordCorrect) {
        ...
        header('Location: jahia_index_en.php');
        echo 'You are logged in !';
    }
    else {
        $pbc3 = 'Ooopsss... Wrong Id or Password  !';
        header('Location: jahia_connexion_en.php?pbc=' . $pbc3);
    }
}
if (isset($_POST['auto']))
{
