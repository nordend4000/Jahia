...
session_start();
     ...
     $ok = 'Merci le commentaire a bien été ajouté !';
     // Puis rediriger vers commentaire du billet
     header('Location: jahia_blog_article.php?id_article='.$_GET['id_article'].'&ok='.$ok );
     ...
     {
       $pb = "L'ajout du commentaire a echoué. <br>Merci de remplir les champs 'Auteur' et 'Commentaire' correctement...";
