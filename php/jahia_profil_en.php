...
<html>
    <head>
         <title>Jahia's website - profile</title>
    </head>
    <body>
        <div id="bloc_page"> 
            ...
            <h2><img src="images/push.png" alt="push decoration" width="5%">   PERSONAL PROFILE  :</h2>
            <div style="text-align: center">
  ...
  if (preg_match("#^[0-9]#", $donnees1['photo_name']))
  {
    ...
    { // alors use jpeg setting
        ...
        <p>Welcome <strong>
               ...
               { echo $_COOKIE['pseudo'];}
               else {echo "";}?></strong>  on your personal space !</p> <?php

            echo '<span id="upload"><img src="uploads/'.$mininame.'" alt="photo de profil" />';
                
            echo '<h4><a href="jahia_copyrighter.php">Click to enlarge image</a></h4></span>'; 
        ...
        else   // sinon on utilise png
        {
            ...
            $req = $bdd->prepare('SELECT id, pseudo, email, date_inscription, telephone, rue, code_postal, ville, pays FROM membres WHERE pseudo = ?');
        ...
        <div style="text-align: left">
            <p> <img src="images/logo.png" alt="logo decoration" width="4%">   <strong>Member N°<?php echo htmlspecialchars($donnees['id']); ?> :  </strong>  from <?php echo htmlspecialchars($donnees['date_inscription']); ?></p>
            <p><strong>Nickname : </strong> <?php echo htmlspecialchars($donnees['pseudo']);?></p>
            <p><strong>E-mail : </strong> <?php echo htmlspecialchars($donnees['email']);?></p>
            <p><strong>Phone Number: </strong> <?php echo htmlspecialchars($donnees['telephone']);?></p>

            <h3>My address: </h3>
            <p><strong>Street : </strong> <?php echo htmlspecialchars($donnees['rue']);?></p>
            <p><strong>Zip Code : </strong>  <?php echo htmlspecialchars($donnees['code_postal']);?></p>
            <p><strong>Suburb : </strong> <?php echo htmlspecialchars($donnees['ville']);?></p>
            <p><strong>Country : </strong> <?php echo htmlspecialchars($donnees['pays']);?></p>
        </div>
        <div class="centrer" style="text-align: center">
            <img src="images/logo.png" alt="logo decoration" width="4%">
            <h6><a href="jahia_profil_perso_update_en.php">Change my login & password </a></h6>
            
            <h6><a href="jahia_profil_perso_new_en.php">Update my personal details</a></h6>
            
            <div id="photo_profil"><h6><a href="jahia_upload_en.php">Change my profile picture</a></h6>

            <h6><a href="jahia_profil_liste_commentaires_en.php">Show my list of comments</a></h6>   
            
            <h6><a href="jahia_index_en.php">Back to home page</a></h6>
            <img src="images/logo.png" alt="logo decoration" width="4%">
            <br><br><h5><a href="admin/jahia_admin.php">Webmaster</a></h5>
            </div>
         </div>
